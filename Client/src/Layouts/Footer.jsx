    ...
    <footer className="relative overflow-hidden mt-auto bg-emerald-900 text-white">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          {/* Quick Links */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-white mb-4 pb-2 border-b-2 border-emerald-400 inline-block">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-white mb-4 pb-2 border-b-2 border-emerald-400 inline-block">Contact Us</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-center group">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{displayTimings}</p>
                </div>
              </li>
            </ul>
                ...
                {[
                  ...
                  social.href && (
                    <a
                      ...
                      className={`w-full px-4 py-3 rounded-lg bg-emerald-900/50 border border-emerald-800/50 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent text-white placeholder-emerald-300/50`}
        ...
        <div className="border-t border-gray-700/50 pt-6 text-center">
          ...
          <p className="text-xs text-gray-500">
            Developed by <a href="mailto:sahin401099@gmail.com" className="text-teal-400 hover:underline">Sahin Arman</a>
          </p>
        </div>
      </div>
    </footer>
